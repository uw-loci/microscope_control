...
class JAICameraProperties:
    ...
    #
    # IMPORTANT: The JAI 'Temperature' property (JAICamera-Temperature) is the
    # physical sensor temperature in degrees C -- a thermal reading. It is NOT
    # a color temperature or white balance parameter. AWB corrections are stored
    # in an opaque internal pipeline and cannot be read via any exposed property.
    ...
    # NOTE: set_white_balance_mode() and run_auto_white_balance() were removed
    # because the JAI camera's hardware AWB cannot be reliably controlled
    # through Pycromanager. Camera AWB must be set manually in MicroManager's
    # Device Property Browser. To clear AWB: restart MicroManager and wait
    # ~30 seconds.
    ...
    def clear_awb_corrections(self) -> None:
        ...
        Note: AWB corrections set through MicroManager's GUI may persist
        even after this call. To fully clear AWB: restart MicroManager
        and wait ~30 seconds.
        """
